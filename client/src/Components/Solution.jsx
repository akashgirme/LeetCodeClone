                            ...
                            <Tab eventKey="Description" title="Description">
                                ...
                                {problem ? (
                                    <ul className='list-unstyle'>
                                        <li><strong>Problem Id: </strong>{problem.problemid}</li>
                                        <li><strong>Title: </strong>{problem.title}</li>
                                        {/* <pre>This tag is for preserving text formatting</pre> */}
                                        <li><strong>Description: </strong><pre className='px-4 text-wrap'>{problem.description}</pre></li>
                                        <li><strong>Example Input:</strong><br/><pre className='px-5 pt-2 text-monospace'>{problem.exampleinput}</pre></li>
                                        <li><strong>Example Output</strong><br/><pre className='px-5 pt-2 text-monospace'>{problem.exampleoutput}</pre></li>
                                        <li><strong>Explanation</strong><br/>{problem.exampleexplanation}</li>
                                    </ul>
                                    ) : (
