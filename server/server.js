      ...
      db.query(
        ...
        (solutionErr, solutionResults) => {
          ...
          res.json({
            ...
            solutionId: solutionResults.insertId,
          });
        },
      );
    },
      ...
      db.query(
        ...
        (existingSubmissionErr, existingSubmissionResults) => {
          ...
          if (existingSubmissionResults.length > 0) {
            return res
              .status(400)
              .json({ msg: "Submission already exists for this problem" });
          }
          ...
          db.query(
            ...
            (outputErr, outputResults) => {
              ...
              if (outputResults.length === 0) {
                return res
                  .status(404)
                  .json({ msg: "Expected output not found" });
              }
              ...
              if (output === expectedOutput) {
                ...
                db.query(
                  ...
                  (insertErr) => {
                    ...
                    return res
                      .status(200)
                      .json({ msg: "Submission successful" });
                  },
                );
              } else {
      ...
      db.query(
        ...
        (testCasesDeleteErr) => {
          if (testCasesDeleteErr) {
            console.error(
              "MySQL query error (test cases delete):",
              testCasesDeleteErr,
            );
            return res.status(500).json({ msg: "Internal server error" });
          }
          ...
          db.query(
            ...
            (problemDeleteErr) => {
              if (problemDeleteErr) {
                console.error(
                  "MySQL query error (problem delete):",
                  problemDeleteErr,
                );
                return res.status(500).json({ msg: "Internal server error" });
              }
              ...
              res.json({
                msg: "Problem and associated test cases deleted successfully",
              });
            },
          );
        },
  ...
  db.query(
    ...
    (checkProblemErr, checkProblemResults) => {
      ...
      if (checkProblemResults.length > 0) {
        return res
          .status(400)
          .json({ msg: "Problem with the same title already exists" });
      }
            ...
            db.query(
              ...
              (testCasesInsertErr) => {
                ...
                db.commit((commitErr) => {
                  ...
                  res.json({
                    msg: "Problem and test cases added successfully",
                  });
                });
              },
            );
